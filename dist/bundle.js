...
/***/ "./src/actions/streams.actions.ts":
/*!****************************************!*\
  !*** ./src/actions/streams.actions.ts ***!
  \****************************************/
/*! exports provided: getStreams */
...
var getStreams = function (gameName) {
    if (gameName === void 0) { gameName = 'Dota 2'; }
    var streamsRequest = new Request("https://api.twitch.tv/kraken/streams/?game=" + gameName, {
        method: 'GET',
        headers: new Headers({
...
var getVideos = function (userId) {
    var streamsRequest = new Request("https://api.twitch.tv/helix/videos?user_id=" + userId, {
        method: 'GET',
        headers: new Headers({
            'Accept': 'application/vnd.twitchtv.v5+json',
            'Client-ID': 'pyoldk5odp2yw4nrhbpd6s5qmq2grb'
...
/***/ "./src/components/GamesSelect/GamesSelect.component.html":
/*!***************************************************************!*\
  !*** ./src/components/GamesSelect/GamesSelect.component.html ***!
  \***************************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<select id=\"gamesSelect\" class=\"form-select select-lg\">\r\n    <% forEach(games, function(game) { %>\r\n        <option>\r\n            <%- game.name %>\r\n        </option>\r\n        <% }); %>\r\n</select>");

/***/ }),

/***/ "./src/components/GamesSelect/GamesSelect.component.ts":
/*!*************************************************************!*\
  !*** ./src/components/GamesSelect/GamesSelect.component.ts ***!
  \*************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _GamesSelect_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./GamesSelect.component.html */ "./src/components/GamesSelect/GamesSelect.component.html");
/* harmony import */ var core_view__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core/view */ "./src/core/view.ts");


var GamesSelect = function (props, targetElement) {
    core_view__WEBPACK_IMPORTED_MODULE_1__["render"](_GamesSelect_component_html__WEBPACK_IMPORTED_MODULE_0__["default"], props, targetElement);
    // Add default value
    targetElement.querySelector('select').value = props.value;
    addEventListeners(props, targetElement);
};
var addEventListeners = function (props, targetElement) {
...
/* harmony default export */ __webpack_exports__["default"] = (GamesSelect);
...
/***/ "./src/components/StreamsList/StreamsList.component.html":
/*!***************************************************************!*\
  !*** ./src/components/StreamsList/StreamsList.component.html ***!
  \***************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<% forEach(streams, function(stream) { %>\r\n    <tr data-element=\"streamTableRow\" data-channel-id=\"<%- stream.channel._id %>\" data-channel-name=\"<%- stream.channel.name %>\" style=\"cursor: pointer\">\r\n        <td>\r\n            <figure class=\"avatar avatar-lg\">\r\n                <img src=\"<%- stream.preview.small %>\">\r\n            </figure>\r\n        </td>\r\n        <td>\r\n            <%- stream.channel.display_name %>\r\n        </td>\r\n    </tr>\r\n    <% }); %>");

/***/ }),

/***/ "./src/components/StreamsList/StreamsList.component.ts":
/*!*************************************************************!*\
  !*** ./src/components/StreamsList/StreamsList.component.ts ***!
  \*************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _StreamsList_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./StreamsList.component.html */ "./src/components/StreamsList/StreamsList.component.html");
/* harmony import */ var core_view__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core/view */ "./src/core/view.ts");


;
var StreamsList = function (props, targetElement) {
    core_view__WEBPACK_IMPORTED_MODULE_1__["render"](_StreamsList_component_html__WEBPACK_IMPORTED_MODULE_0__["default"], props, targetElement);
    addEventListeners(props, targetElement);
};
var addEventListeners = function (props, targetElement) {
    var handler = function (e) {
...
/* harmony default export */ __webpack_exports__["default"] = (StreamsList);


/***/ }),

/***/ "./src/components/VideosList/VideosList.component.html":
/*!*************************************************************!*\
  !*** ./src/components/VideosList/VideosList.component.html ***!
  \*************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<% forEach(videos, function(video) { %>\r\n<% var thumbnail = video.thumbnail_url.replace('%{width}', '240').replace('%{height}', '120')  %>\r\n<div  class=\"column col-2 col-xl-4 col-lg-4 col-md-6 col-sm-12\" style=\"padding: .4rem;\" >\r\n    <a href=\"<%- video.url %>\" data-element=\"videoCol\" target=\"_blank\" rel=\"noopener\" data-video-id=\"<%- video.id %>\">\r\n        <div class=\"card\">\r\n            <div class=\"card-image\">\r\n                <div style=\"min-height: 120px; background: url('<%- thumbnail %>'), url('https://vod-secure.twitch.tv/_404/404_processing_320x180.png'); background-size: cover; background-position: center;\"\r\n                    class=\"img-responsive\" alt=\"OS X El Capitan\"></div>\r\n            </div>\r\n            <div class=\"card-header\">\r\n                <div class=\"card-title h6\">\r\n                    <%- video.title %>\r\n                </div>\r\n                <div class=\"card-subtitle text-gray\"><%- video.duration %></div>\r\n            </div>\r\n        </div>\r\n    </a>\r\n</div>\r\n<% }); %>");

/***/ }),

/***/ "./src/components/VideosList/VideosList.component.ts":
/*!***********************************************************!*\
  !*** ./src/components/VideosList/VideosList.component.ts ***!
  \***********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _VideosList_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./VideosList.component.html */ "./src/components/VideosList/VideosList.component.html");
/* harmony import */ var core_view__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core/view */ "./src/core/view.ts");


;
var VideosList = function (props, targetElement) {
    core_view__WEBPACK_IMPORTED_MODULE_1__["render"](_VideosList_component_html__WEBPACK_IMPORTED_MODULE_0__["default"], props, targetElement);
    addEventListeners(props, targetElement);
};
var addEventListeners = function (props, targetElement) {
    var handler = function (e) {
...
/* harmony default export */ __webpack_exports__["default"] = (VideosList);
...
/*!**************************!*\
  !*** ./src/core/view.ts ***!
  \**************************/
/*! exports provided: render, buildTemplate, addEventListeners */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "render", function() { return render; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "buildTemplate", function() { return buildTemplate; });
...
var render = function (html, props, targetElement) {
    var template = buildTemplate(html, props);
    insertToDOM(template, targetElement);
};
var insertToDOM = function (html, targetElement) {
    targetElement.innerHTML = html;
};
var buildTemplate = function (template, props) {
    return lodash_template__WEBPACK_IMPORTED_MODULE_0___default()(template)(props);
};
...
/* harmony import */ var actions_streams_actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! actions/streams.actions */ "./src/actions/streams.actions.ts");
/* harmony import */ var actions_videos_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! actions/videos.actions */ "./src/actions/videos.actions.ts");
/* harmony import */ var components_Player_Player_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! components/Player/Player.component */ "./src/components/Player/Player.component.ts");
/* harmony import */ var components_GamesSelect_GamesSelect_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! components/GamesSelect/GamesSelect.component */ "./src/components/GamesSelect/GamesSelect.component.ts");
/* harmony import */ var components_StreamsList_StreamsList_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! components/StreamsList/StreamsList.component */ "./src/components/StreamsList/StreamsList.component.ts");
/* harmony import */ var components_VideosList_VideosList_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! components/VideosList/VideosList.component */ "./src/components/VideosList/VideosList.component.ts");
...
var player = Object(components_Player_Player_component__WEBPACK_IMPORTED_MODULE_3__["default"])();
var getGamesRequest = new Request('https://api.twitch.tv/helix/games/top', {
    method: 'GET',
    headers: new Headers({
        'Client-ID': 'pyoldk5odp2yw4nrhbpd6s5qmq2grb'
    }),
...
fetch(getGamesRequest)
    .then(function (res) { return res.json(); })
    .then(function (json) {
    Object(components_GamesSelect_GamesSelect_component__WEBPACK_IMPORTED_MODULE_4__["default"])({ 'games': json.data, value: 'Dota 2', forEach: lodash_foreach__WEBPACK_IMPORTED_MODULE_0___default.a, onChange: getStreamsAndRender }, document.getElementById('gamesSelectContainer'));
});
var getStreamsAndRender = function (gameName) {
    if (gameName === void 0) { gameName = 'Dota 2'; }
    Object(actions_streams_actions__WEBPACK_IMPORTED_MODULE_1__["getStreams"])(gameName).then(function (json) {
        var onStreamClick = function (channelName, channelId) {
            player.setChannel(channelName);
            player.play();
            getVideosAndRender(channelId);
        };
        var streamsTable = document.getElementById('streamsTable');
        Object(components_StreamsList_StreamsList_component__WEBPACK_IMPORTED_MODULE_5__["default"])({ streams: json.streams, onStreamClick: onStreamClick, forEach: lodash_foreach__WEBPACK_IMPORTED_MODULE_0___default.a }, streamsTable);
    });
};
var getVideosAndRender = function (channelId) {
    Object(actions_videos_actions__WEBPACK_IMPORTED_MODULE_2__["getVideos"])(channelId).then(function (json) {
        var videosDiv = document.getElementById('videos');
        var onVideoClick = function (videoId) {
            player.setVideo('v' + videoId, 0);
            player.play();
        };
        Object(components_VideosList_VideosList_component__WEBPACK_IMPORTED_MODULE_6__["default"])({ videos: json.data, onVideoClick: onVideoClick, forEach: lodash_foreach__WEBPACK_IMPORTED_MODULE_0___default.a }, videosDiv);
    });
};
getStreamsAndRender();
