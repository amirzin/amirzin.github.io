...
/* harmony import */ var components_Player_Player_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! components/Player/Player.component */ "./src/components/Player/Player.component.ts");
/* harmony import */ var components_GamesSelect_GamesSelect_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! components/GamesSelect/GamesSelect.component */ "./src/components/GamesSelect/GamesSelect.component.ts");
/* harmony import */ var components_StreamsList_StreamsList_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! components/StreamsList/StreamsList.component */ "./src/components/StreamsList/StreamsList.component.ts");





var player = Object(components_Player_Player_component__WEBPACK_IMPORTED_MODULE_2__["default"])();
...
fetch(getGamesRequest)
    .then(function (res) { return res.json(); })
    .then(function (json) {
    Object(components_GamesSelect_GamesSelect_component__WEBPACK_IMPORTED_MODULE_3__["default"])({ 'games': json.data, value: 'Dota 2', forEach: lodash_foreach__WEBPACK_IMPORTED_MODULE_0___default.a, onChange: getStreamsAndRender }, document.getElementById('gamesSelectContainer'));
});
var getStreamsAndRender = function (gameName) {
    ...
    Object(actions_streams_actions__WEBPACK_IMPORTED_MODULE_1__["getStreams"])(gameName).then(function (json) {
        var onStreamClick = function (channelName) {
            player.setChannel(channelName);
            player.play();
        };
        var streamsTable = document.getElementById('streamsTable');
        Object(components_StreamsList_StreamsList_component__WEBPACK_IMPORTED_MODULE_4__["default"])({ streams: json.streams, onStreamClick: onStreamClick, forEach: lodash_foreach__WEBPACK_IMPORTED_MODULE_0___default.a }, streamsTable);
    });
};
getStreamsAndRender();
